...
void ntt_a21 (input_stream_int32  * restrict s1_in,
	...
	for (int i = 0; i < 64; i+=16){
		...
		v4int32 * restrict po0 = (v4int32 * restrict) (ntt_01 + i); // write to buffer
		v4int32 * restrict po1 = (v4int32 * restrict) (ntt_01 + 64 + i);
		v4int32 * restrict po2 = (v4int32 * restrict) (ntt_01 + 128 + i);
		v4int32 * restrict po3 = (v4int32 * restrict) (ntt_01 + 192 + i);
