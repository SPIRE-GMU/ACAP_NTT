...
#include <twiddle_2048.h>

using namespace adf;

void ntt_2048_last (input_stream_int32  * restrict s1_in,
	...
	v8int32  * restrict tw1  = (v8int32  * restrict)tw2048;

	v8int32  * restrict tw1c  = (v8int32  * restrict)tw2048c;
