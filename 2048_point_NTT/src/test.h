...
public:
    ...
    TEST(){
		...
		plin[4] = input_plio::create("in00p",  plio_32_bits, "data/in00p.txt", 1250);
		plin[5] = input_plio::create("in00q",  plio_32_bits, "data/in00q.txt", 1250);
		plin[6] = input_plio::create("in00r",  plio_32_bits, "data/in00r.txt", 1250);
		plin[7] = input_plio::create("in00s",  plio_32_bits, "data/in00s.txt", 1250);
