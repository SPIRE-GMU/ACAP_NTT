...
void ntt_a11 (input_stream_int32  * restrict s1_in,
    ...
    v8int32 * restrict tw3 = (v8int32 * restrict) (stage1_tw +16);
    v8int32 * restrict tw3c = (v8int32 * restrict)(stage1_twc+16);

    v8int32 * restrict tw4 = (v8int32 * restrict) (stage1_tw + 32);
    v8int32 * restrict tw4c = (v8int32 * restrict)(stage1_twc+ 32);
	...
	for (int i = 0; i < 2; i++){
		...
		*(ntt_a   + 2) = ext_w(ma1_mod,0);
		*(ntt_a   + 4) = ext_w(ma2_mod,0);
		*(ntt_a++ + 6) = ext_w(ma2_mod,1);  // eight elem increment
	...
	for (int i = 0; i < 2; i++){
		...
		*(ntt_b   + 2) = ext_w(ma1_mod,0);
		*(ntt_b   + 4) = ext_w(ma2_mod,0);
		*(ntt_b++ + 6) = ext_w(ma2_mod,1);  // eight elem increment
	...
	for (int i = 0; i < 2; i++){
		...
		*(ntt_c   + 2) = ext_w(ma1_mod,0);
		*(ntt_c   + 4) = ext_w(ma2_mod,0);
		*(ntt_c++ + 6) = ext_w(ma2_mod,1);  // eight elem increment
	...
	for (int i = 0; i < 2; i++){
		...
		*(ntt_d   + 2) = ext_w(ma1_mod,0);
		*(ntt_d   + 4) = ext_w(ma2_mod,0);
		*(ntt_d++ + 6) = ext_w(ma2_mod,1);  // eight elem increment
	...
	for (int i = 0; i<64; i+=16){
		...
		ntt_0wa1 = (v4int32 * restrict)  (ntt_1+ i + 4);
		ntt_0wa2 = (v4int32 * restrict)  (ntt_1+ i + 8);
		ntt_0wa3 = (v4int32 * restrict)  (ntt_1+ i + 12);
