...
extern int32 ntt_0[256];



extern int32 ntt_01[256];


extern int32 ntt_4_1[256];

extern int32 last_tw2[256];
extern int32 last_tw3[256];
extern int32 last_tw4[256];

extern int32 last_tw2c[256];
extern int32 last_tw3c[256];
extern int32 last_tw4c[256];

extern int32 ntt_last[1024];
extern int32 tw2048[1024];
extern int32 tw2048c[1024];
...
public:
    ...
    test_grapha00(){
    	...
    	adf::connect<window<256*4>>(in, kl.in[0]);
...
public:
    ...
    total_graph(){
    	...
    	adf::connect<stream> n3 (g01.out[0], g20.in[0]);
    	adf::connect<stream> n4 (g01.out[1], g20.in[1]);
...
public:
    ...
    acc_1_graph(){
    	...
    	kz = adf::kernel::create(ntt_2048_last);
    	adf::runtime<ratio>(kz) = 0.9 ;
    	source(kz) = "ntt_2048_last.cc" ;

    	buf1 = parameter::array(tw2048);
    	connect<>(buf1, kz);

    	buf2 = parameter::array(tw2048c);
    	connect<>(buf2, kz);
