...
void ntt_a01 (input_stream_int32  * restrict s1_in,
    ...
    v8int32 * restrict tw3 = (v8int32 * restrict) (stage0_tw +64);
    v8int32 * restrict tw3c = (v8int32 * restrict)(stage0_twc+64);

    v8int32 * restrict tw4 = (v8int32 * restrict) (stage0_tw + 128);
    v8int32 * restrict tw4c = (v8int32 * restrict)(stage0_twc+ 128);
	...
	for (int i = 0; i < 8; i++){
		...
		*(ntt_0a   + 8) = ext_w(ma1_mod,0);
		*(ntt_0a   + 16) = ext_w(ma2_mod,0);
		*(ntt_0a++ + 24) = ext_w(ma2_mod,1);  // eight elem increment
	...
	for (int i = 0; i<256; i+=64){
		...
		ntt_0wa1 = (v4int32 * restrict)  (ntt_0 + i + 16);
		ntt_0wa2 = (v4int32 * restrict)  (ntt_0 + i + 32);
		ntt_0wa3 = (v4int32 * restrict)  (ntt_0 + i + 48);
