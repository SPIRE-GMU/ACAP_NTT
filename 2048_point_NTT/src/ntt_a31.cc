...
void ntt_a31 (input_stream_int32  * restrict s1_in,
	...
	int32 const chess_storage(%chess_alignof(int32)) stage3_tw2[8] =   {1, 4134, 11567, 8246, 1, 4134, 11567, 8246};
	int32 const chess_storage(%chess_alignof(int32)) stage3_tw3[8] =   {1, 8246, 5146, 1479, 1, 8246, 5146, 1479};
	int32 const chess_storage(%chess_alignof(int32)) stage3_tw4[8] =   {1, 11567, 8155, 5146, 1, 11567, 8155, 5146};

	int32 const chess_storage(%chess_alignof(int32)) stage3_tw2c[8] =   {87374, 361205037, 1010657635, 720487841, 87374, 361205037, 1010657635, 720487841};
	int32 const chess_storage(%chess_alignof(int32)) stage3_tw3c[8] =   {87374, 720487841, 449627750, 129226475, 87374, 720487841, 449627750, 129226475};
	int32 const chess_storage(%chess_alignof(int32)) stage3_tw4c[8] =   {87374, 1010657635, 712536786, 449627750, 87374, 1010657635, 712536786, 449627750};
