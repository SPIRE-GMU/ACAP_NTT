...
void ntt_a00 (input_window_int32  * restrict inputx,
			output_stream_int32 *  restrict s_out){


    v32int32 *xbuff =  (v32int32 *)inputx->ptr;

    int32 * restrict ntt_tmp1 = (int32 * restrict) ntt_1a;

    v32int32 * restrict ntt_tmp1a  = (v32int32 * restrict) ntt_1a;
	...
	v8int32 * restrict pi0 = (v8int32 * restrict)  ntt_tmp1;
	v8int32 * restrict pi1 = (v8int32 * restrict) (ntt_tmp1 + 256);
	v8int32 * restrict pi2 = (v8int32 * restrict) (ntt_tmp1 + 512);
	v8int32 * restrict pi3 = (v8int32 * restrict) (ntt_tmp1 + 768);
	...
	writeincr_v4(s_out,ext_v(x3buff,0));
	writeincr_v4(s_out,ext_v(x3buff,1));
	writeincr_v4(s_out,ext_v(x3buff,2));
	writeincr_v4(s_out,ext_v(x3buff,3));
...
/*	unsigned long long time2=tile.cycles(); //second time
	...
	printf("first %lld \n", time);
		...
		writeincr_v4(s_out, readincr_v4(s_in));
	writeincr_v4(s_out, readincr_v4(s_in));
	writeincr_v4(s_out, readincr_v4(s_in));
	writeincr_v4(s_out, readincr_v4(s_in));
