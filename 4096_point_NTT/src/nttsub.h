...
inline __attribute__((always_inline)) void stage0_ntt (int32 * restrict x, int32 * restrict tw,
	...
	//chess_loop_range(4,)
	{
		...
		m1 = srs(lmul4_antisym (x1buff, 0, 0x3210, 4, 12, zbuff, 0, 0x0000, 1) , 0) ; // four secnd-points of the four-blocks  can do +q if negative here

		m2 = srs(lmul4_sym     (x1buff, 0, 0x3210, 4, 12, zbuff, 0, 0x0000, 2)  ,0) ;
		m3 = srs(lmul4_antisym (x1buff, 0, 0x3210, 4, 12, zbuff, 0, 0x0000, 3)  ,0) ; // can do +q if negative here
